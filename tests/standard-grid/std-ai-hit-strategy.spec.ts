...
function* provideHitChoices(): Generator<HitChoicesSet> {
    ...
    yield new HitChoicesSet(
        'regression 0455',
        flatten([
            createMoves(HitResponse.MISS, 'G1'),
            createMoves(HitResponse.MISS, 'F2'),
            createMoves(HitResponse.MISS, 'D9'),
            createMoves(HitResponse.MISS, 'I9'),
            createMoves(HitResponse.HIT, 'H10'),
            createMoves(HitResponse.HIT, 'G10'),
            createMoves(HitResponse.MISS, 'I10'),
            createMoves(HitResponse.HIT, 'F10'),
            createMoves(HitResponse.SUNK, 'E10'),
            createMoves(HitResponse.MISS, 'C5'),
            createMoves(HitResponse.MISS, 'F7'),
            createMoves(HitResponse.MISS, 'A2'),
            createMoves(HitResponse.MISS, 'E3'),
            createMoves(HitResponse.MISS, 'J3'),
            createMoves(HitResponse.MISS, 'B6'),
            createMoves(HitResponse.MISS, 'I4'),
            createMoves(HitResponse.HIT, 'G6'),
            createMoves(HitResponse.MISS, 'F6'),
            createMoves(HitResponse.MISS, 'H6'),
            createMoves(HitResponse.HIT, 'G5'),
            createMoves(HitResponse.HIT, 'G4'),
            createMoves(HitResponse.HIT, 'G3'),
            createMoves(HitResponse.SUNK, 'G2'),
            createMoves(HitResponse.MISS, 'I7'),
            createMoves(HitResponse.MISS, 'G8'),
            createMoves(HitResponse.MISS, 'J2'),
            createMoves(HitResponse.MISS, 'H3'),
            createMoves(HitResponse.MISS, 'A5'),
            createMoves(HitResponse.MISS, 'J5'),
            createMoves(HitResponse.HIT, 'H9'),
            createMoves(HitResponse.SUNK, 'H8'),
            createMoves(HitResponse.MISS, 'C7'),
            createMoves(HitResponse.MISS, 'C4'),
            createMoves(HitResponse.MISS, 'I1'),
            createMoves(HitResponse.MISS, 'E9'),
            createMoves(HitResponse.MISS, 'D2'),
            createMoves(HitResponse.MISS, 'F4'),
            createMoves(HitResponse.MISS, 'E6'),
            createMoves(HitResponse.HIT, 'B3'),
            createMoves(HitResponse.HIT, 'C3'),
            createMoves(HitResponse.HIT, 'A3'),
            createMoves(HitResponse.SUNK, 'D3'),
            createMoves(HitResponse.MISS, 'A4'),
            createMoves(HitResponse.MISS, 'F1'),
        ]),
        startingV4,
        'HitTargetSurroundings<G10>',
        ['G9'],
    );
    ...
    yield new HitChoicesSet(
        ...
        flatten([
            ...
            createMoves(HitResponse.MISS, 'A4'),
            createMoves(HitResponse.MISS, 'F1'),
            createMoves(HitResponse.MISS, 'G9'),
        ]),
        startingV4,
        'GridScreening<3>',
        ['C1', 'D5', 'A8', 'D8', 'J8', 'B9', 'C10'],
    );
    ...
    yield new HitChoicesSet(
        ...
        flatten([
            createMoves(HitResponse.HIT, 'C5'),
            createMoves(HitResponse.HIT, 'C4'),
            createMoves(HitResponse.HIT, 'C6'),
            createMoves(HitResponse.SUNK, 'C3'),
            createMoves(HitResponse.HIT, 'D9'),
            createMoves(HitResponse.MISS, 'C9'),
            createMoves(HitResponse.SUNK, 'D10'),
            createMoves(HitResponse.MISS, 'H9'),
            createMoves(HitResponse.MISS, 'G8'),
            createMoves(HitResponse.MISS, 'J6'),
            createMoves(HitResponse.MISS, 'B8'),
            createMoves(HitResponse.MISS, 'F7'),
            createMoves(HitResponse.MISS, 'B3'),
            createMoves(HitResponse.MISS, 'J1'),
            createMoves(HitResponse.MISS, 'H4'),
            createMoves(HitResponse.MISS, 'A2'),
            createMoves(HitResponse.MISS, 'D5'),
            createMoves(HitResponse.MISS, 'A7'),
            createMoves(HitResponse.MISS, 'E1'),
            createMoves(HitResponse.HIT, 'I5'),
            createMoves(HitResponse.MISS, 'H5'),
            createMoves(HitResponse.MISS, 'I4'),
            createMoves(HitResponse.HIT, 'I6'),
            createMoves(HitResponse.HIT, 'I7'),
            createMoves(HitResponse.SUNK, 'I8'),
            createMoves(HitResponse.MISS, 'I9'),
            createMoves(HitResponse.MISS, 'C7'),
            createMoves(HitResponse.MISS, 'C2'),
            createMoves(HitResponse.MISS, 'J5'),
            createMoves(HitResponse.MISS, 'H6'),
            createMoves(HitResponse.MISS, 'H7'),
            createMoves(HitResponse.MISS, 'J7'),
            createMoves(HitResponse.MISS, 'H8'),
            createMoves(HitResponse.MISS, 'J8'),
        ]),
        startingV4,
        'HitTargetSurroundings<C6>',
        ['B6', 'D6'],
    );
}
